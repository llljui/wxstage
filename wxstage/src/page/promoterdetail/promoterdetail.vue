    ...
    <el-col :span="10" :offset="1" class="lost">
      <span>剩余钻石：</span><span>{{mydias}}</span>
        ...
        <el-col :span="10" :offset="1">
            <el-date-picker type="date" placeholder="选择日期" v-model="date1" style="width: 100%;margin-top:1vh;"></el-date-picker>
        </el-col>
        <el-col class="line" :span="2" style="text-align:center;margin-top:2vh;">-</el-col>
        <el-col :span="10">
            <el-date-picker type="date" placeholder="选择时间" v-model="date2" style="width: 100%;margin-top:1vh;"></el-date-picker>
        </el-col>
    <el-col :span="22" :offset="1" class="bor1">
     <el-button class="btnsearch" type="primary">查询</el-button>
    </el-col>
    <el-col :span="10" :offset="1">
      <h5 class="textc">团队消耗：{{consume}}</h5>
    </el-col>
    <el-col :span="10" >
      <h5 class="textc">团队充值：{{charge}}</h5>
    </el-col>
    <el-table
      height="270"
      align="center"
